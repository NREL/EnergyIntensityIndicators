...
class CommercialIndicators(LMDI):
    ...
    def collect_data(self):
        conversion_factors = self.eia_comm.conversion_factors()
        print(conversion_factors)
        SEDS_CensusRgn = self.eia_comm.get_seds()
        print(SEDS_CensusRgn)
        national_calibration = self.eia_comm.national_calibration()
        print(national_calibration)
