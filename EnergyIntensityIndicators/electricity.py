...
class ElectricityIndicators(CalculateLMDI):
    ...
    def __init__(self, directory, output_directory, level_of_aggregation, lmdi_model=['multiplicative'], base_year=1985):
        ...
        self.Table84c_url = 'https://www.eia.gov/totalenergy/data/annual/xls/stb0804c.xls' # elec_power_eia.eia_api(id_='456') 
    ...
    def industrial_sector_chp_renew(self):
        ...
        wood_activity = self.eia_elec.eia_api(id_='TOTAL.WDI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column R
        waste_activity = self.eia_elec.eia_api(id_='TOTAL.WSI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column T
    ...
    def industrial_sector_chp_fossil(self):
        ...
        coal_activity = self.eia_elec.eia_api(id_='TOTAL.CLI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column B
        petroleum_activity = self.eia_elec.eia_api(id_='TOTAL.PAI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column D
        natgas_activity = self.eia_elec.eia_api(id_='TOTAL.NGI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column F
        othgas_activity = self.eia_elec.eia_api(id_='TOTAL.OJI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column H
    ...
    def industrial_sector_total(self):
        ...
        hydroelectric_activity = self.eia_elec.eia_api(id_='TOTAL.HVI5PUS.A', id_type='series').multiply(0.001) # Table 8.2d11 Column P
        other_activity = None #  self.eia_elec.eia_api(id_='', id_type='series').multiply(0.001) # Table 8.2d11 Column AD
    ...
    def comm_sector_chp_renew(self):
        ...
        wood_activity = None # self.eia_elec.eia_api(id_='', id_type='series').multiply(0.001) # Table 8.2d column R
        waste_activity = self.eia_elec.eia_api(id_='TOTAL.WSC5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column T
    ...
    def comm_sector_chp_fossil(self):
        ...
        coal_activity = self.eia_elec.eia_api(id_='TOTAL.CLC5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column B
        petroleum_activity = self.eia_elec.eia_api(id_='TOTAL.PAC5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column D
        natgas_activity = self.eia_elec.eia_api(id_='TOTAL.NGC5PUS.A', id_type='series').multiply(0.001) # Table 8.2d column F
        othgas_activity = None #  self.eia_elec.eia_api(id_='', id_type='series').multiply(0.001) # Table 8.2d column H
    ...
    def comm_sector_total(self):
        ...
        hydroelectric_activity = None # self.eia_elec.eia_api(id_='', id_type='series').multiply(0.001) # Table 8.2d11 Column P
    ...
    def elec_power_sector_chp_renew(self):
        ...
        wood_activity = self.eia_elec.eia_api(id_='TOTAL.WDEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column R
        waste_activity = self.eia_elec.eia_api(id_='TOTAL.WSEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column T
    ...
    def elec_power_sector_chp_fossil():
        ...
        coal_activity = self.eia_elec.eia_api(id_='TOTAL.CLEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column B
        petroleum_activity = self.eia_elec.eia_api(id_='TOTAL.PAEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column D
        natgas_activity = self.eia_elec.eia_api(id_='TOTAL.NGEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column F
        othgas_activity = self.eia_elec.eia_api(id_='TOTAL.OJEGPUS.A', id_type='series').multiply(0.001) # Table 8.2c column H
    ...
    def elec_power_sector_chp_total():
        ...
        other_activty = None # self.eia_elec.eia_api(id_='', id_type='series').multiply(0.001) # Table 8.2c columnAD

        data_dict = {'Other': {'energy': {'primary': other_energy}, 'activity': other_activty}}

    def electricity_only_renew(self):
        wood_activity = self.eia_elec.eia_api(id_='TOTAL.WDL1BUS.A', id_type='series').multiply(0.001)  # Table 8.3d I, 8.5C R
        waste_activity = self.eia_elec.eia_api(id_='TOTAL.WSL1BUS.A', id_type='series').multiply(0.001) # Table 8.3d J, 8.5C T
        geothermal_activity = self.eia_elec.eia_api(id_='TOTAL.GEEGBUS.A', id_type='series').multiply(0.001) # Table 8.4 T
        solar_activity = self.eia_elec.eia_api(id_='TOTAL.SOEGBUS.A', id_type='series').multiply(0.001)  # Table 8.4 V
        wind_activity = self.eia_elec.eia_api(id_='TOTAL.WYEGBUS.A', id_type='series').multiply(0.001) # Table 8.4 X

        wood_energy = self.eia_elec.eia_api(id_='TOTAL.WDEGPUS.A', id_type='series').multiply(0.001)  # Table 8.2b S, 8.2c R
        waste_energy = self.eia_elec.eia_api(id_='TOTAL.WSEGPUS.A', id_type='series').multiply(0.001)  # Table 8.2b T, 8.2c T
        geothermal_energy = self.eia_elec.eia_api(id_='TOTAL.GEEGPUS.A', id_type='series').multiply(0.001)  # Table 8.2b V, 8.2c V
        solar_energy = self.eia_elec.eia_api(id_='TOTAL.SOEGPUS.A', id_type='series').multiply(0.001) # Table 8.2b X, 8.2c X
        wind_energy = self.eia_elec.eia_api(id_='TOTAL.WYEGPUS.A', id_type='series').multiply(0.001)  # Table 8.2b Z, 8.2c Z
    ...
    def electricity_only_fossil(self):
        ...
        coal_activity = self.eia_elec.eia_api(id_='TOTAL.CLEGPUS.A', id_type='series').multiply(0.001)  # 8.2b B, 8.2c B
        petroleum_activity = self.eia_elec.eia_api(id_='TOTAL.PAEGPUS.A', id_type='series').multiply(0.001)  # 8.2b D, 8.2c D
        natgas_activity = self.eia_elec.eia_api(id_='TOTAL.NGEGPUS.A', id_type='series').multiply(0.001)  # 8.2b B, 8.2c F
        othgas_activity = self.eia_elec.eia_api(id_='TOTAL.OJEGPUS.A', id_type='series').multiply(0.001) # 8.2c H
    ...
    def electricity_only_total(self):
        nuclear_energy = self.eia_elec.eia_api(id_='TOTAL.NUEGBUS.A', id_type='series').multiply(0.001) # 8.4b L
        hydroelectric_energy = self.eia_elec.eia_api(id_='TOTAL.HVEGBUS.A', id_type='series').multiply(0.001)  # 8.4b N

        nuclear_activity = self.eia_elec.eia_api(id_='TOTAL.NUEGPUS.A', id_type='series').multiply(0.001) # 8.2b L
        hydroelectric_activity = self.eia_elec.eia_api(id_='TOTAL.HVEGPUS.A', id_type='series').multiply(0.001)  # 8.2b O
