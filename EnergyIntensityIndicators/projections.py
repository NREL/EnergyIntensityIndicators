...
class MakeProjections(CalculateLMDI):
    ...
    def __init__(self, directory, output_directory, level_of_aggregation, 
        ...
        self.primary_activity = {'Residential': 'households', 'Industrial': 'value_of_shipments'}
    ...
    def commercial_projections(self):
        ...
        data_dict = {'energy': {'elec': energy_use_commercial_electricity_us, 
                                'deliv': energy_use_commercial_delivered_energy_us}, 
    ...
    def collect_data(self):
        ...
        data_dict = {'Economy_Wide': {'Residential': self.residential_projections(), 
                                      ...
                                      'Electric Power': self.electricity_projections(),
...
if __name__ == '__main__': 
    indicators = MakeProjections(directory='./EnergyIntensityIndicators/Data', 
                                 output_directory='./Results', 
                                 level_of_aggregation='Economy_Wide', lmdi_model=['multiplicative', 'additive'],
                                 end_year=2040, base_year=2020) 
